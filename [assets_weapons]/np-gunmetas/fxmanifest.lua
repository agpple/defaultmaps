-- This Package Leaked By Tc Leaks.
-- For More Leaks Join Our Discord Server: https://discord.gg/tc-leaks / https://discord.gg/u7fNWZPxRB
-- LEAKED BY TC LEAKS
...
files {
	...
	data_file 'WEAPONINFO_FILE' 'weaponrailgun.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weaponrailgun.meta'
	data_file 'WEAPONINFO_FILE' 'weaponcombatpdw.meta'
	...
	data_file 'WEAPONINFO_FILE_PATCH' 'weaponm14.meta'
	data_file 'WEAPONINFO_FILE' 'weapondragunov.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weapondragunov.meta'
	data_file 'WEAPONINFO_FILE' 'weapons_g22.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weapons_g22.meta'
	data_file 'WEAPONINFO_FILE' 'weaponminismg2.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weaponminismg2.meta'
	data_file 'WEAPONINFO_FILE' 'weapons_doubleaction.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weapons_doubleaction.meta'
	data_file 'WEAPONINFO_FILE' 'weapons_specialcarbine_mk2.meta'
	data_file 'WEAPONINFO_FILE_PATCH' 'weapons_specialcarbine_mk2.meta'
	data_file 'WEAPONINFO_FILE' 'weaponhominglauncher.meta'
